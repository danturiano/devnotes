  ...
  return (
    <section className="min-h-screen flex items-center justify-center text-balance flex-col container">
      ...
      <div className="space-y-12">
        <span className="type-words sm:flex justify-center text-5xl hidden">
          ‎
        </span>
        <h1 className="text-5xl text-start font-bold text-primary md:text-6xl xl:text-8xl sm:text-center md:font-extrabold">
          Your Modern Developer Knowledge Hub
        </h1>
        <p className="text-pretty sm:text-balance sm:text-center font-normal text-md md:text-2xl md:text-balance xl:text-3xl">
